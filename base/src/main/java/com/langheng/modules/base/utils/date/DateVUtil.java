package com.langheng.modules.base.utils.date;
...
public class DateVUtil {

    /*
    时间戳对比
    左>右 flase
     */
    public static boolean currentTimeMillis(int timestamp, int afterTimestamp) {
        boolean time = false;
    ...
    public static int getTimeMillis() {
        return (int) (System.currentTimeMillis() / 1000);//单位为秒
    }
...
//        LocalDate test = LocalDate.parse(seconds);
