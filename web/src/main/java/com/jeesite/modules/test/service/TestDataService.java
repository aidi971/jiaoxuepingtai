...
//		System.out.println(pageMap.getCount());
	 ...
	 */
	public void executeTestTask(BaseUserService baseUserService, Integer i, Long l, Float f, Double d, String s){
		System.out.println(DateUtils.getTime() + " 任务执行了~~~  bean: " + baseUserService + ", i: " + i
				+ ", l: " + l + ", f: " + f + ", d: " + d + ", s: " + s);
	}
